...
function Main() {
  ...
  return (
    <div
      className={
        genreList === null || chartPlaylistList === null
                    ...
                    return (
                      <ArtistAlbum
                        ...
                        viewData={
                          <div>
                            <div
                              onClick={() => artistAlbums(item.id)}
                              className="single-artist"
                              style={{
                                backgroundImage: `url(${item.picture_big})`,
                              }}
                            >
                              <div className="artist-overlay "></div>
                            </div>
                            <p className="white song-artist-name">
                ...
                <Carousel responsive={responsive} arrows={true}>
                  {chartAlbumsList.data.map((item, index) => {
                    return (
                      <div
                        key={index}
                        onClick={() => albumTraks(item)}
                        className="single-album-container"
                      >
                        <div
                          className="single-genre"
                          style={{ backgroundImage: `url(${item.cover_big})` }}
                        >
                          ...
                          <div className="track-item">
                            ...
                            >
                              <div className="track-overlay">
                                <h3 className="white genre-title">
                                  {item.title}
                                </h3>
                              </div>
                            </div>
                            ...
                            <p className="white song-album-name small-text">
                              {item.album.title}
                            </p>
                          </div>
                        }
                  ...
                  {chartPodcastList.map((item, index) => {
                    return (
                      <div key={index} onClick={() => viewPodcast(item.link)}>
                        ...
                        <p className="white song-artist-name">
                          <strong>{item.fans} fans</strong>
                        </p>
                        <p className="white song-album-name small-text three-lines-text">
                          {item.description}
                        </p>
                      </div>
                    );
